...
int main()
{
    ...
    // ------------------------------------
    //unsigned int programID = LoadShaders("4.1.texture.vs", "4.1.texture.fs");
    unsigned int programID = LoadShaders("src/1.getting_started/4.1.textures/4.1.texture.vs", "src/1.getting_started/4.1.textures/4.1.texture.fs");
	...
	stbi_set_flip_vertically_on_load(true); // Image will be upside down, this fixes it.
