...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("4.3.texture.vs", "4.3.texture.fs");
    unsigned int programID = LoadShaders("src/1.getting_started/4.4.textures_exercise2/4.3.texture.vs", "src/1.getting_started/4.4.textures_exercise2/4.3.texture.fs");
