...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("4.4.texture.vs", "4.4.texture.fs");
    unsigned int programID = LoadShaders("src/1.getting_started/4.5.textures_exercise3/4.4.texture.vs", "src/1.getting_started/4.5.textures_exercise3/4.4.texture.fs");
