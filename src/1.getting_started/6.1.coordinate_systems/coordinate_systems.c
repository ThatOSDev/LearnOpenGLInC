...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("6.1.coordinate_systems.vs", "6.1.coordinate_systems.fs");
    unsigned int programID = LoadShaders("src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.vs", "src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.fs");
