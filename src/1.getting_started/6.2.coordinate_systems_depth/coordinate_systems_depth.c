...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("6.2.coordinate_systems.vs", "6.2.coordinate_systems.fs");
    unsigned int programID = LoadShaders("src/1.getting_started/6.2.coordinate_systems_depth/6.2.coordinate_systems.vs", "src/1.getting_started/6.2.coordinate_systems_depth/6.2.coordinate_systems.fs");
