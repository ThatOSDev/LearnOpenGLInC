...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("7.1.camera.vs", "7.1.camera.fs");
    unsigned int programID = LoadShaders("src/1.getting_started/7.1.camera_circle/7.1.camera.vs", "src/1.getting_started/7.1.camera_circle/7.1.camera.fs");
