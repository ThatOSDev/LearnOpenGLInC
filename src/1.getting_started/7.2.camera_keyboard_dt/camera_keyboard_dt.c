...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("7.2.camera.vs", "7.2.camera.fs");
    unsigned int programID = LoadShaders("src/1.getting_started/7.2.camera_keyboard_dt/7.2.camera.vs", "src/1.getting_started/7.2.camera_keyboard_dt/7.2.camera.fs");
