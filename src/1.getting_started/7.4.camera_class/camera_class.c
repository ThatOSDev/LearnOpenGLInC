...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("7.4.camera.vs", "7.4.camera.fs");
    unsigned int programID = LoadShaders("src/1.getting_started/7.4.camera_class/7.4.camera.vs", "src/1.getting_started/7.4.camera_class/7.4.camera.fs");
