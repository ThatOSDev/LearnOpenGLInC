...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("1.colors.vs", "1.colors.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/1.colors/1.colors.vs", "src/2.lighting/1.colors/1.colors.fs");
    // unsigned int programID = LoadShaders("1.light_cube.vs", "1.light_cube.fs");
    unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/1.colors/1.light_cube.vs", "src/2.lighting/1.colors/1.light_cube.fs");
