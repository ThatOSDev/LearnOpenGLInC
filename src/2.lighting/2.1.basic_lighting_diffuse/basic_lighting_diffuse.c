...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("2.1.basic_lighting.vs", "2.1.basic_lighting.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/2.1.basic_lighting_diffuse/2.1.basic_lighting.vs", "src/2.lighting/2.1.basic_lighting_diffuse/2.1.basic_lighting.fs");
    // unsigned int programID = LoadShaders("2.1.light_cube.vs", "2.1.light_cube.fs");
    unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/2.1.basic_lighting_diffuse/2.1.light_cube.vs", "src/2.lighting/2.1.basic_lighting_diffuse/2.1.light_cube.fs");
