...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("2.2.basic_lighting.vs", "2.2.basic_lighting.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/2.2.basic_lighting_specular/2.2.basic_lighting.vs", "src/2.lighting/2.2.basic_lighting_specular/2.2.basic_lighting.fs");
    // unsigned int programID = LoadShaders("2.2.light_cube.vs", "2.2.light_cube.fs");
    unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/2.2.basic_lighting_specular/2.2.light_cube.vs", "src/2.lighting/2.2.basic_lighting_specular/2.2.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        setVec3_XYZ(lightingShaderID, "objectColor", 1.0f, 0.5f, 0.31f);
        setVec3_XYZ(lightingShaderID, "lightColor",  1.0f, 1.0f, 1.0f);
        setVec3(lightingShaderID, "lightPos", lightPos);
