...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("3.2.materials.vs", "3.2.materials.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/3.2.materials_exercise1/3.2.materials.vs", "src/2.lighting/3.2.materials_exercise1/3.2.materials.fs");
    // unsigned int programID = LoadShaders("3.2.light_cube.vs", "3.2.light_cube.fs");
    unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/3.2.materials_exercise1/3.2.light_cube.vs", "src/2.lighting/3.2.materials_exercise1/3.2.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // light properties
        setVec3_XYZ(lightingShaderID, "light.ambient", 1.0f, 1.0f, 1.0f); // note that all light colors are set at full intensity
        setVec3_XYZ(lightingShaderID, "light.diffuse", 1.0f, 1.0f, 1.0f);
        setVec3_XYZ(lightingShaderID, "light.specular", 1.0f, 1.0f, 1.0f);

        // material properties
        setVec3_XYZ(lightingShaderID, "material.ambient", 0.0f, 0.1f, 0.06f);
        setVec3_XYZ(lightingShaderID, "material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
        setVec3_XYZ(lightingShaderID, "material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
