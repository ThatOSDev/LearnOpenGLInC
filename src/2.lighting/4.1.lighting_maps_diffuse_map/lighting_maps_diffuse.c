...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("4.1.lighting_maps.vs", "4.1.lighting_maps.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/4.1.lighting_maps_diffuse_map/4.1.lighting_maps.vs", "src/2.lighting/4.1.lighting_maps_diffuse_map/4.1.lighting_maps.fs");
    // unsigned int programID = LoadShaders("4.1.light_cube.vs", "4.1.light_cube.fs");
    unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/4.1.lighting_maps_diffuse_map/4.1.light_cube.vs", "src/2.lighting/4.1.lighting_maps_diffuse_map/4.1.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // material properties
        setVec3_XYZ(lightingShaderID, "material.specular", 0.5f, 0.5f, 0.5f);
        setFloat(lightingShaderID, "material.shininess", 64.0f);
