...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("4.2.lighting_maps.vs", "4.2.lighting_maps.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/4.2.lighting_maps_specular_map/4.2.lighting_maps.vs", "src/2.lighting/4.2.lighting_maps_specular_map/4.2.lighting_maps.fs");
    // unsigned int programID = LoadShaders("4.2.light_cube.vs", "4.2.light_cube.fs");
    unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/4.2.lighting_maps_specular_map/4.2.light_cube.vs", "src/2.lighting/4.2.lighting_maps_specular_map/4.2.light_cube.fs");
