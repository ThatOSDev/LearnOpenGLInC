...
int main()
{
    ...
    // -------------------------
    // unsigned int programID = LoadShaders("5.1.light_casters.vs", "5.1.light_casters.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/5.1.light_casters_directional/5.1.light_casters.vs", "src/2.lighting/5.1.light_casters_directional/5.1.light_casters.fs");
    // unsigned int programID = LoadShaders("5.1.light_cube.vs", "5.1.light_cube.fs");
    // unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/5.1.light_casters_directional/5.1.light_cube.vs", "src/2.lighting/5.1.light_casters_directional/5.1.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        useShader(lightingShaderID);
        setVec3_XYZ(lightingShaderID, "light.direction", -0.2f, -1.0f, -0.3f);
