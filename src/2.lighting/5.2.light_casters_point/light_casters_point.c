...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("5.2.light_casters.vs", "5.2.light_casters.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/5.2.light_casters_point/5.2.light_casters.vs", "src/2.lighting/5.2.light_casters_point/5.2.light_casters.fs");
    // unsigned int programID = LoadShaders("5.2.light_cube.vs", "5.2.light_cube.fs");
     unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/5.2.light_casters_point/5.2.light_cube.vs", "src/2.lighting/5.2.light_casters_point/5.2.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        useShader(lightingShaderID);
        setVec3(lightingShaderID, "light.direction", lightPos);
        setVec3(lightingShaderID, "viewPos", Camera->Position);

        // light properties
        setVec3_XYZ(lightingShaderID, "light.ambient", 0.2f, 0.2f, 0.2f);
        setVec3_XYZ(lightingShaderID, "light.diffuse", 0.5f, 0.5f, 0.5f);
