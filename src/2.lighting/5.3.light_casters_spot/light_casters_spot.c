...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("5.3.light_casters.vs", "5.3.light_casters.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/5.3.light_casters_spot/5.3.light_casters.vs", "src/2.lighting/5.3.light_casters_spot/5.3.light_casters.fs");
    // unsigned int programID = LoadShaders("5.3.light_cube.vs", "5.3.light_cube.fs");
     unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/5.3.light_casters_spot/5.3.light_cube.vs", "src/2.lighting/5.3.light_casters_spot/5.3.light_cube.fs");
