...
int main()
{
    ...
    // ------------------------------------
    // unsigned int programID = LoadShaders("5.4.light_casters.vs", "5.4.light_casters.fs");
    unsigned int lightingShaderID = LoadShaders("src/2.lighting/5.4.light_casters_spot_soft/5.4.light_casters.vs", "src/2.lighting/5.4.light_casters_spot_soft/5.4.light_casters.fs");
    // unsigned int programID = LoadShaders("5.4.light_cube.vs", "5.4.light_cube.fs");
     unsigned int lightCubeShaderID = LoadShaders("src/2.lighting/5.4.light_casters_spot_soft/5.4.light_cube.vs", "src/2.lighting/5.4.light_casters_spot_soft/5.4.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        useShader(lightingShaderID);
        setVec3(lightingShaderID, "light.position", Camera->Position);
        setVec3(lightingShaderID, "light.direction", Camera->Front);
        setFloat(lightingShaderID, "light.cutOff", cos(glm_rad(12.5f)));
        setFloat(lightingShaderID, "light.outerCutOff", cos(glm_rad(17.5f)));
        setVec3(lightingShaderID, "viewPos", Camera->Position);

        // light properties
        setVec3_XYZ(lightingShaderID, "light.ambient", 0.1f, 0.1f, 0.1f);
        // we configure the diffuse intensity slightly higher; the right lighting conditions differ with each lighting method and environment.
        // each environment and lighting type requires some tweaking to get the best out of your environment.
        setVec3_XYZ(lightingShaderID, "light.diffuse", 0.8f, 0.8f, 0.8f);
        setVec3_XYZ(lightingShaderID, "light.specular", 1.0f, 1.0f, 1.0f);
        setFloat(lightingShaderID, "light.constant", 1.0f);
        setFloat(lightingShaderID, "light.linear", 0.09f);
        setFloat(lightingShaderID, "light.quadratic", 0.032f);
