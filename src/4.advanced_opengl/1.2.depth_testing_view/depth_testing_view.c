...
int main()
{
    ...
    // -------------------------
    //unsigned int programID = LoadShaders("1.2.depth_testing.vs", "1.2.depth_testing.fs");
    unsigned int programID = LoadShaders("src/4.advanced_opengl/1.2.depth_testing_view/1.2.depth_testing.vs", "src/4.advanced_opengl/1.2.depth_testing_view/1.2.depth_testing.fs");
