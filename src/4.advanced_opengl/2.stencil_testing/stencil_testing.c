...
#include <learnopengl/model.h>   // stb_image & assimp
...
int main()
{
    ...
    // -------------------------
    //unsigned int programID = LoadShaders("2.stencil_testing.vs", "2.stencil_testing.fs");
    //unsigned int shaderSingleColor = LoadShaders("2.stencil_testing.vs", "2.stencil_single_color.fs");
    unsigned int programID = LoadShaders("src/4.advanced_opengl/2.stencil_testing/2.stencil_testing.vs", "src/4.advanced_opengl/2.stencil_testing/2.stencil_testing.fs");
    unsigned int singleColorID = LoadShaders("src/4.advanced_opengl/2.stencil_testing/2.stencil_testing.vs", "src/4.advanced_opengl/2.stencil_testing/2.stencil_single_color.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        setMat4(singleColorID, "view", view);
        setMat4(singleColorID, "projection", projection);
        ...
        setMat4(singleColorID, "model", model);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        glm_mat4_identity(model); // Reset the model Matrix
        glm_translate(model, (vec3){2.0f, 0.0f, 0.0f});
        glm_scale(model, (vec3){scale, scale, scale});
